...
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=7, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=8, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=9, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=10, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=11, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=12, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=13, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=14, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=15, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=16, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=17, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=18, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=19, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=20, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=21, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=22, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
\begin{frame}{Ejemplo}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=1.5\textheight, page=23, keepaspectratio]{IPE/point_visibility.pdf}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
