...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      Asignamos nombres a los vértices en sentido antihorario.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      $v_{1}$ está a la izquierda de $qv_{0}$, así que lo agregamos a la pila.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      $v_{2}$ está a la izquierda de $qv_{1}$, así que lo agregamos a la pila.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      $v_{3}$ está a la izquierda de $qv_{2}$, así que lo agregamos a la pila.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      $v_{4}$ está a la derecha de $\overrightarrow{qv_{3}}$ y está a la izquierda de $\overrightarrow{v_{2}v_{3}}$. Así que sacamos el primer elemento del stack. Nombramos a $v_{3}v_{4}$ arista frontal y a $v_{2}$ como $u$.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      La arista frontal intersecta a $uq$, así que sacamos el primer elemento del stack. Ahora $u$ es $v_{1}$.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      La arista frontal intersecta a $uq$, así que sacamos el primer elemento del stack. Ahora $u$ es $v_{0}$. Asignamos a $m$ como el punto de intersección de $\overrightarrow{qv_{4}}$ con la arista que contiene a $u$
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      Agregamos a $m$ y $v_{4}$ a la pila.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      Como $v_{5}$ está a la izquierda de $\overrightarrow{qv_{4}}$, lo agregamos a la pila.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
...
\begin{frame}{Ejemplo}
  \begin{columns}
    \begin{column}{0.3\textwidth}
      \raggedright % Alineación a la izquierda para mejorar la legibilidad
      Como $v_{6}$ está a la izquierda de $\overrightarrow{qv_{5}}$, lo agregamos a la pila.
    \end{column}
    \begin{column}{0.7\textwidth}
      \vspace{-2.5cm} % Ajustar el espacio vertical para subir la imagen
      \begin{figure}
