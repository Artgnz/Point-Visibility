...
%        \begin{enumerate}
%            \item Realizar el CH: $O(n)$
%            \item La ejecución recorre los n vértices una vez y para cada vértice se realizan operaciones constantes en el stack: $O(n)$
%        \end{enumerate}
%Como se trata de un polígono simple, los pasos involucrados en búsquedas y operaciones geométricas son más eficientes ya que no hay intersecciones complejas entre los bordes del polígono.
%    \begin{center}
